...
function goForJoinActivity(){
	//提交form
	document.ActivityForm.action="${pageContext.request.contextPath }/toSignUpPage.do";
 	...
 	$.ajax({
  		type:'GET',  	
  		 success:function(data){
  			window.location.href="toSignUpPage.do"
  		 }
  	});	 	
}
...
<form name="ActivityForm"  method="post">
	...
	<hr/>
	<button  id="sendButton" type="submit" onclick= "goForJoinActivity();" class="btn btn-lg btn-info" >报名</button>
